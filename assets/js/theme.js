...
(function () {
	...
	"use strict";
	//active service run
	var pgurl = decodeURIComponent(window.location.href);
	console.log(pgurl);
	if (jQuery(".hover-up").length) {
		jQuery(".hover-up a").each(function () {
		...
		Basic: {
			...
			MobileMenu: function () {
				...
				if ($('.mobile_menu li.dropdown ul').length) {
					$('.mobile_menu li.dropdown').append('<div class="dropdown-btn"><span class="fas fa-caret-left"></span></div>');
